...
- First, we will specify that we want only one OCPU in each of the worker and master nodes. This reduces the hourly cost of running our cluster.  On **lines 15 and 16**, uncomment the **k8sMasterShape** and **k8sWorkerShape** parameters, and set both values to as below (or use values provided by your workshop instructor):
